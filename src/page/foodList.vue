  ...
  <div class="fillcontain">
    ...
    <div class="table_container">
      ...
      >
        ...
        <el-table-column label="商品名称" prop="headName"></el-table-column>
        <el-table-column label="价格" prop="price"></el-table-column>
        <el-table-column label="商品介绍" prop="productDescribe"></el-table-column>
      ...
      <el-dialog title="修改商品信息" v-model="dialogFormVisible">
        <el-form :model="selectTable">
          <el-form-item label="商品名称" label-width="100px">
            <el-input v-model="selectTable.headName" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="商品介绍" label-width="100px">
            <el-input v-model="selectTable.productDescribe"></el-input>
          </el-form-item>
...
export default {
  ...
  computed: {
    count: function() {
      return this.$store.state.shop.productCount;
    },
    tableData: function() {
  ...
  methods: {
    ...
    handleServiceAvatarScucess(res, file) {
      if (res.status == 0) {
        this.selectTable.headImage = res.data.url;
      } else {
