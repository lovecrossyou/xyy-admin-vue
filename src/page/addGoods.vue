      ...
      <el-col :span="14" :offset="4">
        ...
        >
          <el-form-item label="当前店铺">
            <el-input disabled v-model="shop.name"></el-input>
          </el-form-item>
        </el-form>
        ...
        <el-form
          ...
          class="form food_form"
        >
          <el-form-item label="商品名称" prop="headName">
            <el-input v-model="foodForm.headName"></el-input>
          </el-form-item>
          <el-form-item label="商品品牌" prop="brand">
            <el-input v-model="foodForm.brand"></el-input>
          </el-form-item>
          <el-form-item label="库存" prop="stock">
            <el-input type="number" v-model="foodForm.stock"></el-input>
          </el-form-item>
          <el-form-item label="商品详情" prop="productDescribe">
            <el-input type="textarea" v-model="foodForm.productDescribe"></el-input>
          </el-form-item>
          <el-form-item label="上传商品图片">
            ...
            >
              <img v-if="foodForm.headImage" :src="foodForm.headImage" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
          <el-form-item label="食品规格">
            <el-radio class="radio" v-model="foodSpecs" label="one">单规格</el-radio>
            <el-radio class="radio" v-model="foodSpecs" label="more" disabled>多规格</el-radio>
          </el-form-item>
          <el-row v-if="foodSpecs == 'one'">
            ...
            <el-form-item label="原价">
              <el-input-number v-model="foodForm.originalPrice" :min="0" :max="10000"></el-input-number>
            </el-form-item>
          ...
          <el-form-item>
            <el-button type="primary" @click="addFood('foodForm')">确认添加</el-button>
          </el-form-item>
        </el-form>
...
export default {
  ...
  computed: {
    ...mapState({
      shop: state => state.shop.selectShop
    }),
  ...
  methods: {
    ...
    uploadImg(res, file) {
      if (res.status == 0) {
        this.foodForm.headImage = res.data.url;
      } else {
